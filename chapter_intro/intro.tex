...
\end{figure}
\Cref{fig:intro-big-picture} describes an simple example of AWJM process. From
\Cref{fig:intro-big-picture}, we can see the erosion of a brittle solid due to
...
\Cref{chap:csph} improves the collision model by incorporating a contact force
...
integration strategy in PySPH. \Cref{chap:fsi} discusses the interaction between
